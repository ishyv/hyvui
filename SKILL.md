...
A register shifts the *weight distribution* of the design — which typeface leads, how present ornaments are, how heavy surfaces feel. Apply to `<body>` or any root container:

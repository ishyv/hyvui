...
>
  ...
  <ParallaxLayer strength={28}>
    <div style="position: relative; z-index: 10; text-align: center; padding: var(--space-scene);">
      ...
      <Stack direction="horizontal" justify="center" gap="var(--space-sm)" style="margin-top: 2rem;">
...
<Stack gap="var(--space-xl)" style="padding: var(--space-scene); min-height: 100dvh; justify-content: center;">

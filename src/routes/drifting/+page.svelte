...
<div class="system-page drifting-page">
  ...
  <div class="content-shell">
    ...
    <div class="main-message" class:visible={showContent}>
      ...
      <p class="body-text">
        the analysis engine has reached its quiet threshold. it will return once the channel
        clears on its own.
      </p>
...
<style>
  ...
  :global(.drifting-vignette) {
    z-index: 2;
    background:
      radial-gradient(circle at center, transparent 30%, color-mix(in srgb, black 60%, transparent) 100%),
      radial-gradient(circle at top, color-mix(in srgb, var(--status-fail) 16%, transparent), transparent 40%);
  }
  ...
  :global(.drifting-corners .hyvui-corner-tl) { animation-delay: 0.3s; }
  :global(.drifting-corners .hyvui-corner-tr) { animation-delay: 0.5s; }
  :global(.drifting-corners .hyvui-corner-bl) { animation-delay: 0.7s; }
  :global(.drifting-corners .hyvui-corner-br) { animation-delay: 0.9s; }

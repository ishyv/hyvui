...
<style>
  .system-page {
    ...
    overflow: hidden;
    background:
      radial-gradient(circle at top, color-mix(in srgb, var(--accent) 10%, transparent), transparent 24%),
  ...
  :global(.warm-vignette) {
    background:
      radial-gradient(ellipse at 50% 0%, color-mix(in srgb, var(--accent) 9%, transparent), transparent 36%),
      radial-gradient(ellipse at 50% 100%, transparent 56%, color-mix(in srgb, black 56%, transparent));
  }

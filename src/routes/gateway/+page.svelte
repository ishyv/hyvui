		...
		const orbits = [
			{
				radiusX: width * 0.12,
				radiusY: height * 0.07,
				rotation: time * 0.0028,
				color: rgba(tokens.color.text, 0.08)
			},
			{
				radiusX: width * 0.2,
				radiusY: height * 0.1,
				rotation: -time * 0.002,
				color: rgba(tokens.color.accent, 0.14)
			},
			{
				radiusX: width * 0.28,
				radiusY: height * 0.13,
				rotation: time * 0.0014,
				color: rgba(tokens.color.signal, 0.14)
			}
		];

<script lang="ts">
  ...
  function drawFrame(singleFrame = false) {
    ...
    ctx.lineWidth = 7;
    ctx.strokeStyle = fill > 0.9
      ? rgba(tokens.color.signal, 0.42)
      : rgba(tokens.color.accent, 0.36);
    ctx.stroke();
...
<div class="system-page">
  ...
  <div class="content-shell">
    ...
    <div class="main-message" class:visible={showContent}>
      ...
      <p class="body-text">the channel needs a moment. the request was received but not processed.</p>

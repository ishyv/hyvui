...
<Card>
  ...
  <Text variant="body">stacked layers, quiet contrast.</Text>
	...
	const selectedCount = $derived([selectAlpha, selectBeta, selectGamma].filter(Boolean).length);
	...
	<div class="docs-shell">
		...
		<main class="docs-content">
			...
			<section id="overview" class="docs-section">
				...
				<Stack gap="var(--space-md)" class="docs-block">
					...
					<Alert variant="info" title="design posture">
						spacing carries the hierarchy. labels stay uppercase. contrast is intentional, not
						decorative.
					</Alert>
				</Stack>
			</section>
			...
			<section id="primitives" class="docs-section">
				...
				<Grid mode="template" cols="minmax(0, 1.2fr) minmax(0, 1fr)" gap="var(--space-xl)">
					<Stack gap="var(--space-sm)">
						<Text variant="heading" as="h3">heading tier</Text>
						<Text variant="body" color="soft">
							body text. short lines, deliberate spacing. nothing squeezed together.
						</Text>
						<Text variant="italic" color="muted">italics are for the quieter line.</Text>
			...
			<section id="layout" class="docs-section">
				...
				<Grid cols={3} gap="var(--space-md)" class="docs-card-grid">
					...
					<Card>
						...
						{/snippet}
						<Text variant="body" color="soft"
							>column-based layouts. pass a number for equal columns or a full template string.</Text
						>
					</Card>
					<Card>
						{#snippet header()}
				...
				<Panel withInset>
					...
					<Stack gap="var(--space-sm)">
						<Text variant="body" color="soft"
							>full-section container for forms, data tables, and anything that needs room.</Text
						>
			...
			<section id="inputs" class="docs-section">
				...
				<Panel>
					...
					{/snippet}
					<Grid mode="template" cols="minmax(0, 1fr) minmax(0, 1fr)" gap="var(--space-lg)">
						<Stack gap="var(--space-sm)">
			...
			<section id="feedback" class="docs-section">
				...
				<Grid mode="template" cols="minmax(0, 1fr) minmax(0, 1fr)" gap="var(--space-lg)">
					<Stack gap="var(--space-sm)">
						<Alert variant="ok" title="signal stable">upstream route steady. latency normal.</Alert>
			...
			<section id="scenes" class="docs-section">
				...
				<div class="docs-scene">
					<NarrativeScene chapter="chapter 01">
						...
						{#snippet copy()}
							<Text variant="body" color="soft">
								narrow copy on the left, open canvas on the right. good for about pages and story
								sections.
							</Text>
						{/snippet}
						{#snippet canvas()}
